...
class LEDMatrix {
  constructor(elementId, rows = 8, cols = 8, matrixName = 'A') {
    ...
    this.hardwareRef = {
      ...
      spiPins: { CS: 10, CLK: 13, DIN: 11 }  // Corrected: Match Arduino pins (D13=CLK, D11=DIN, D10=CS)
    };
    this.initialize();
  }
...
document.addEventListener('DOMContentLoaded', () => {
  try {
    ...
    console.error('❌ Failed to initialize LED matrices:', error);
    alert('Failed to initialize LED display. Please refresh the page.');
  }
});